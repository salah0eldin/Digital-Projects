...
HD_PWD='D:/Learning/DigitalKareem/Projects/SPI_Slave_Interface/viva/SPI_2/SPI_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_interface_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_slave_interface_2.tcl -notrace
