...
HD_PWD='D:/Learning/DigitalKareem/Projects/SPI_Slave_Interface/viva/SPI_2/SPI_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_interface_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_slave_interface_2.tcl
